				  ...
				  <?php 
					...
					<?php
							...
							<div class='alert alert-warning'>
								...
								<span class='pull-right'><a href='index.php?page=barang&stok=yes'>Tabel Items <i class='fa fa-angle-double-right'></i></a></span>
							</div>
							";	
						}
					?>
					  ...
					  <div class="col-md-3">
                      		<div class="panel panel-primary">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Nama Items</h5>
                      			</div>
                      			<div class="panel-body">
									<center><h1><?php echo number_format($hasil_barang);?></h1></center>
								</div>
								<div class="panel-footer">
									<h4 style="font-size:15px;font-weight:700;"><a href='index.php?page=barang'>Tabel Items <i class='fa fa-angle-double-right'></i></a></h4>
								</div>
	                      	</div><!--/grey-panel -->
                      	</div><!-- /col-md-3-->
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-success">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Stok Items</h5>
                      			</div>
                      			<div class="panel-body">
                      ...
                      <!-- STATUS PANELS -->
                      	...
                      	<div class="col-md-3">
                      		<div class="panel panel-danger">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Kategori Items</h5>
                      			</div>
                      			<div class="panel-body">
