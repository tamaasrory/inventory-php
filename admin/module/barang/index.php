 	...
 	<section class="wrapper">
 		...
 		<div class="row">
 			<div class="col-lg-12 main-chart">
 				...
 				<?php
					$sql = " select * from barang b left join kategori k on k.id_kategori = b.id_kategori where b.stok <= 3 AND k.nama_kategori NOT LIKE '%jasa%'";
 				...
 				<?php
						echo "
								<div class='alert alert-warning'>
									...
									<span class='pull-right'><a href='index.php?page=barang&stok=yes'>Cek Items <i class='fa fa-angle-double-right'></i></a></span>
								</div>
								";
					}
					?>
 				...
 				<a href="index.php?page=barang&stok=yes" style="margin-right :0.5pc;" class="btn btn-warning btn-md pull-right">
 							...
 							<?php
								...
								?>
 								<tr>
 									...
 									<td>
 										<?php if (strtolower($isi['nama_kategori']) != 'jasa') { ?>
 											<?php if ($isi['stok'] == '0') { ?>
 									...
 									<td>
 										<?php if ($isi['stok'] <=  '3' && strtolower($isi['nama_kategori']) != 'jasa') { ?>
 					...
 					<div class="modal-dialog">
 						...
 						<div class="modal-content" style=" border-radius:0px;">
 							<div class="modal-header" style="background:#285c64;color:#fff;">
 								...
 								<h4 class="modal-title"><i class="fa fa-plus"></i> Tambah Items</h4>
 							</div>
 							<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
 								<div class="modal-body">
 									...
 									<table class="table table-striped bordered">
 										...
 										<tr>
 											<td>Nama Items</td>
 											<td><input type="text" placeholder="Nama Items" required class="form-control" name="nama"></td>
 										</tr>
 										<tr>
 											<td>Merk Items</td>
 											<td><input type="text" placeholder="Merk Items" required class="form-control" name="merk"></td>
 										</tr>
 										<tr>
 											<td>Harga Beli</td>
