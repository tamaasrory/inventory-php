	 ...
	 */ 
	 class view {
		...
		function __construct($db){
			...
			function pelanggan_cari($q){
				$sql = "select * from pelanggan WHERE 
				nama like '%{$q}%' OR nomor_hp like '%{$q}%' OR nomor_kendaraan like '%{$q}%'";
				$row = $this-> db -> prepare($sql);
				$row -> execute();
				$hasil = $row -> fetchAll();
				return $hasil;
			...
			function pelanggan_byid($q){
				$sql = "select * from pelanggan WHERE id_pelanggan={$q}";
				$row = $this-> db -> prepare($sql);
				$row -> execute();
				$hasil = $row -> fetch();
				return $hasil;
			...
			function pelanggan_edit($id){
				$sql = "select * from kategori where id_pelanggan=?";
				$row = $this-> db -> prepare($sql);
				$row -> execute(array($id));
				$hasil = $row -> fetch();
				return $hasil;
